...
// public logging API
#ifdef EG_LOGGING
#	define EGLOG(debugLevel, ...) mLogger.log((debugLevel), (debugLevel)<=mLogger.getDebugOutputLevel()?__WFILE__:L"", (debugLevel)<=mLogger.getDebugOutputLevel()?__WFUNCTION__:L"", true, (debugLevel)<=mLogger.getDebugOutputLevel()?__LINE__:0, __VA_ARGS__)
#else
