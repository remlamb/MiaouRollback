...
namespace ExitGames
{
	namespace Common
	{
		namespace Helpers
		{
			...
			{
			public:
				static char* Unicode2UTF8(const EG_CHAR* wstr, unsigned int srcLen, char* dst, unsigned int dstSize);
				static EG_CHAR* UTF82Unicode(const char* str, unsigned int srcSize, EG_CHAR* dst, unsigned int dstLen);
