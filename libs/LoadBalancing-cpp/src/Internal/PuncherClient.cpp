...
namespace ExitGames
{
	namespace LoadBalancing
	{
		namespace Internal
		{
			...
			{
				return buffer.getSize()?mLoadBalancingClient.opRaiseEvent(reliable, buffer.getCArray(), buffer.getSize(), PUNCH_MSG, RaiseEventOptions().setTargetPlayers(targetIDs.getCArray(), targetIDs.getSize())):false;
			}
		}
	}
}
