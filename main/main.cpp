...
public:
	...
	App(game::GameLogic* gl, Renderer* renderer) : game_logic(gl), game_renderer(renderer) {}
...
int main() {
	InitWindow(game::GameLogic::screenWidth, game::GameLogic::screenHeight, "Online Game");
