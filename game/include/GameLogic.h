...
namespace game {
	...
	/**
	* @brief This class manages the game logic, including physics simulation, player management, and input handling.
	* The `GameLogic` class initializes and updates the game world, manages player input, and handles collision detection and response.
	* It creates platforms and ropes within the game world and updates their associated colliders accordingly.
	*
	* The class contains a physics world, player manager, and inputs manager as member variables.
	* It also maintains constants for screen width and height, as well as parameters for platform and rope creation.
	*/
	class GameLogic {
	public:
		...
		void Init() noexcept;
		/**
		 * @brief Updates the game logic, colliders, inputs and apply inputs for players. 
		 */
